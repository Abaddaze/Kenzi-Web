...
const Collection = () => {
  ...
  const toggleCategory = (e) => {
    // If it was already selected, this line removes it from the array.
    // prev.filter(...) creates a new array without the clicked value. 
  ...
  const sortProduct = () => {
    let fpCopy = fitlerProducts.slice();
    ...
    <div className='min-w-60'>
      ...
      <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}>
        ...
        <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
          {/* The checkboxes for the categories */}
